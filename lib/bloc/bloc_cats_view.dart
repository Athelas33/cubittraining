import 'package:cubit_training/bloc/cats_cubit.dart';
import 'package:cubit_training/bloc/cats_repository.dart';
import 'package:cubit_training/bloc/cats_state.dart';
        ...
        body: BlocConsumer<CatsCubit, CatsState>(
          listener: (context, state) {
            if (state is CatsError) {
              Scaffold.of(context)
                  .showSnackBar(SnackBar(content: Text(state.messeage)));
            }
          },
